...
In this situation, you might encounter a critical bug in the version currently used by Ceph daemons and wish to apply a patch. The procedure described in this section should be useful in such cases.

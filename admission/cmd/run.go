...
func run(addr string, port int, conf *hooks.Config) error {
	...
	wh.Register("/validate-prevent-subnamespace-deletion", hooks.NewPreventSubNamespaceDeletionValidator(mgr.GetClient(), dec, &conf.PreventSubNamespaceDeletionValidatorConfig))

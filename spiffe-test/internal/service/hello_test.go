...
func TestNewHelloService(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			allowedIDs: []string{"spiffe://example.com/workload1", "spiffe://example.com/workload2"},
		},
		{
...
func TestHelloService_SayHello(t *testing.T) {
	allowedIDs := []string{
		"spiffe://example.com/workload1",
		"spiffe://example.com/workload2",
	}

...
func setupContainerVeth(netns ns.NetNS, ifName string, mtu int, pr *current.Result, hostVethName string) (*current.Interface, *current.Interface, error) {
...
func cmdAdd(args *skel.CmdArgs) error {
	...
	hostVethName := generateHostVethName("veth", podNS, podName)

	hostInterface, containerInterface, err := setupContainerVeth(netns, args.IfName, conf.MTU, result, hostVethName)
	if err != nil {
		return err
	}
